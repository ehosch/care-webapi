...
{
    Task NotifyShiftAssignedAsync(string userId, DateOnly date, CancellationToken cancellationToken);

    Task NotifyReplacementRequestedAsync(DateOnly date, string requestedByUserId, string? reason, CancellationToken cancellationToken);

    Task NotifyReplacementClaimedAsync(string requesterUserId, string claimedByUserId, DateOnly date, CancellationToken cancellationToken);
